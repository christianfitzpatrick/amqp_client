...
class AMQPMethod:
    ...
    def encode(self):
        ...
        Use this when building a frame that will be sent to the server
        """
    ...
    @abc.abstractmethod
    def decode(self):
        """Decode the method data and arguments

        Use this when unpacking a method frame received from the server
        """
